...
import { SecurityIllustration, PainTime, PainCosts, PainPerformance, PainLegacy, PainHiring } from '@/components/illustrations'
...
export default function AuditoriaSegurancaPage() {
  const t = useTranslations('auditoriaSeguranca')
      ...
      <section className="border-b border-border bg-surface/50">
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-10 px-6 py-16 md:flex-row md:py-24">
          ...
          <div className="w-72 shrink-0 md:w-96">
            <SecurityIllustration className="w-full" />
          </div>
        </div>
      </section>
