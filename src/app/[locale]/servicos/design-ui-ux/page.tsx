...
import { DesignIllustration, PainTime, PainCosts, PainLegacy, PainConversion, PainAccessibility } from '@/components/illustrations'
...
export default function DesignUIUXPage() {
  const t = useTranslations('designUIUX')
  ...
  const deliverables = [
    { Illustration: DesignIllustration, title: t('roadmap.items.0.title'), description: t('roadmap.items.0.description'), highlight: true },
    { icon: '📐', title: t('roadmap.items.1.title'), description: t('roadmap.items.1.description') },
    { icon: '✍️', title: t('roadmap.items.2.title'), description: t('roadmap.items.2.description') },
    { icon: '♿', title: t('roadmap.items.3.title'), description: t('roadmap.items.3.description') },
    { icon: '🌗', title: t('roadmap.items.4.title'), description: t('roadmap.items.4.description') },
    { icon: '🎨', title: t('roadmap.items.5.title'), description: t('roadmap.items.5.description') },
  ]
      ...
      <section className="border-b border-border bg-surface/50">
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-10 px-6 py-16 md:flex-row md:py-24">
          ...
          <div className="w-72 shrink-0 md:w-96">
            <DesignIllustration className="w-full" />
          </div>
        </div>
      </section>
