...
import { SoftwareIllustration, PainPerformance, PainLegacy, PainCosts, PainTime, PainHiring, RoadFrontend, RoadBackend, RoadMobile, RoadApi, RoadDatabase, RoadDevops } from '@/components/illustrations'
...
export default function SoftwareDevelopmentPage() {
  ...
  const deliverables = Array.from({ length: 6 }, (_, i) => ({
    Illustration: deliverableIllustrations[i],
      ...
      <section className="border-b border-border bg-surface/50">
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-10 px-6 py-16 md:flex-row md:py-24">
          ...
          <div className="w-72 shrink-0 md:w-96">
            <SoftwareIllustration className="w-full" />
          </div>
        </div>
      </section>
